...
<fieldset>
	<legend><img src="{$uri}/img/cogs.gif" alt="{l s='Configuration' mod='blockpxplay'}" /> {l s='New filters template' mod='blockpxplay'}</legend>
	<form action="{$current_url}" method="post" class="form-horizontal" onsubmit="return checkForm();">
		...
		<table class="table-configurations">
			<tbody>
				<tr>
					<td class="label">{l s='Template name:' mod='blockpxplay'}</td>
					<td>
				...
				<tr>
					<td class="label">{l s='Categories used for this template:' mod='blockpxplay'}</td>
					<td>{$categories_tree}</td>
				</tr>
				{if isset($asso_shops)}
				<tr>
					<td class="label">
						{l s='Choose shop association:' mod='blockpxplay'}					
					</td>
					<td>{$asso_shops}</td>
				</tr>
				{/if}
				<tr>
					<td class="label">
						{l s='Filters:' mod='blockpxplay'}
						<p class="help-block">{l s='You can drag and drop filters to adjust position' mod='blockpxplay'}</p>
					</td>
					<td>
						<section class="filter_panel">
							<header>
								{l s='Total filters: %s'|sprintf:$total_filters mod='blockpxplay'} - {l s='Selected filters: <span id=\'selected_filters\'>%s</span>'|sprintf:0 mod='blockpxplay'}
							</header>
										...
										<table>
											<tbody>
												<tr>
													...
													<td class="filter-title">{l s='Sub-categories filter' mod='blockpxplay'}</td>
													<td>{l s='Filter result limit:' mod='blockpxplay'}</td>
													<td>
													...
													<td>{l s='Filter style:' mod='blockpxplay'}</td>
													<td>
										...
										<table>
											<tbody>
												<tr>
													...
													<td class="filter-title">{l s='Product stock filter' mod='blockpxplay'}</td>
													<td>{l s='Filter result limit:' mod='blockpxplay'}</td>
													<td>
										...
										<table>
											<tbody>
												<tr>
													...
													<td class="filter-title">{l s='Product condition filter' mod='blockpxplay'}</td>
													<td>{l s='Filter result limit:' mod='blockpxplay'}</td>
													<td>
										...
										<table>
											<tbody>
												<tr>
													...
													<td class="filter-title">{l s='Product manufacturer filter' mod='blockpxplay'}</td>
													<td>{l s='Filter result limit:' mod='blockpxplay'}</td>
													<td>
										...
										<table>
											<tbody>
												<tr>
													...
													<td class="filter-title">{l s='Product weight filter (slider)' mod='blockpxplay'}</td>
													<td>{l s='Filter result limit:' mod='blockpxplay'}</td>
													<td>
										...
										<table>
											<tbody>
												<tr>
													...
													<td class="filter-title">{l s='Product price filter (slider)' mod='blockpxplay'}</td>
													<td>{l s='Filter result limit:' mod='blockpxplay'}</td>
													<td>
...
<script type="text/javascript">
	...
	translations['selected_filters'] = '{l s='Selected filters: %s'|addslashes mod='blockpxplay'}';
</script>
