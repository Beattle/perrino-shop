<?php
/*
* 2007-2014 PrestaShop _tat_ добавила хук
*
* NOTICE OF LICENSE
*
...
class BlockCategories extends Module
{
	...
	public function hookLeftColumn($params)
	{
		...
		if (!$this->isCached('blockcategories.tpl', $cacheId))
		{
			...
			{
				$category = new Category($this->context->cookie->last_visited_category, $this->context->language->id);
				if (Validate::isLoadedObject($category))//Если убрать со след. стьрокой, то выдаст главное название каталога на странице с меню подчинённой категории
