...
class BlockNewProducts extends Module
{
	...
	{
		if (!Configuration::get('NEW_PRODUCTS_NBR'))//Тут по умолчанию присваивается 5, но выводится 20?
			return;
		$newProducts = false;
		if (Configuration::get('PS_NB_DAYS_NEW_PRODUCT'))/*это как раз выводит новые товары  (слева)*/
