<?php
/*
* 2007-2014 PrestaShop <!-- выводит самые продаваемые товары (лидеры, хиты продаж)_tat_ меняла в основном tpl и языковые файлы. Тут, кажется, ничего-->
*
* NOTICE OF LICENSE
*
...
class BlockBestSellers extends Module
{
	...
	public function __construct()
	{
		...
		$this->displayName = $this->l('Хиты продаж');
		$this->description = $this->l('Adds a block bestellers (хиты продаж)\'s top-selling products.');
	...
	public function hookRightColumn($params)
	{
		if (!$this->isCached('blockbestsellers.tpl', $this->getCacheId('blockbestsellers-col')))
		{
			...
			//print_r(BlockBestSellers::$cache_best_sellers);
		}
