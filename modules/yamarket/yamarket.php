...
//							continue;
						...
						if (is_array($combinations) && count($combinations) > 0)
						{
							...
							foreach ($combinations as $combination)
							{
                                ...
                                $comb_array[$combination['id_product_attribute']]['imp_comb'] = implode($comb_array[$combination['id_product_attribute']]['attributes']);
							}
	...
	private function _addProduct($shop, $product, $combination = false)
	{
		...
		$offer->name = $product['name']." $combination[imp_comb]";
