<?php
/*
* 2007-2015 PrestaShop _tat_ Помимо прочего определяет обязательные поля в форме регистрации адреса. дОБАВИЛА 'required' => true, для телефона. А вообще я его переопределила в overide, когда добавляла поле Лифт
*
* NOTICE OF LICENSE
*
...
class AddressCore extends ObjectModel
{
	...
	public static $definition = array(
		...
		'fields' => array(
			...
			'dni' => 				array('type' => self::TYPE_STRING, 'validate' => 'isDniLite', 'required' => false, 'size' => 16),
