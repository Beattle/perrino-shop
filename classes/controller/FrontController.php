<?php
/*
* 2007-2015 PrestaShop _tat_ ������ �������������� ����������� ������, ����� �������� �����������. �� ��� ����� ����� ��� �������� (��� 783) �������� ������������ autotat, �������� ������� ������ HOOK_RIGHT_COLUMN ��� 458
*
* NOTICE OF LICENSE
*
	...
	public function initContent()
	{
		...
		if (!$this->useMobileTheme())
		{
			...
			$this->context->smarty->assign(array(
				...
				'HOOK_RIGHT_COLUMN' => Hook::exec('displayRightColumn'),
				'HOOK_HIT' => Hook::exec('displayHit'),
			));
		}
		else
...
/*<div class="akcii">
<div class="akcii_title">������ 8% �� ����� �����!</div>
<div class="akcii_text">� ����� ��������� ����� ���� ���� - ������ 8% ����!</div>
</div>*/