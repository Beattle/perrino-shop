...
class CategoryControllerCore extends FrontController
{
	...
	public function initContent()
	{
			...
			foreach($products as &$pro)
        {
            ...
            $tax = (float)$product_obj->getTaxesRate(new Address((int)$this->context->cart->{Configuration::get('PS_TAX_ADDRESS_TYPE')}));
            $pro['tax_rate'] = $tax;
    ...
    public function getProductAttributeCombinations($product_id){
        $product = new Product($product_id,$this->context->language->id);
        $combinations = $product->getProductAttributeCombinations($product_id);
