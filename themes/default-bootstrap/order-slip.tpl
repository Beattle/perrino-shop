{*
* 2007-2015 PrestaShop _tat_ добавила .buttontat, на страницу "Вы не получали кредитов"
*
* NOTICE OF LICENSE
*
...
<ul class="footer_links clearfix">
	<li>
		<a class="btn btn-default button button-small buttontat" href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}">
			<span>
