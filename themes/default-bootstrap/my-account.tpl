{*
* 2007-2015 PrestaShop _tat_ последняя ссылка на странице главной уч. записи добавления адреса. Добавила aDirect. сама страница в identity.tpl
*
* NOTICE OF LICENSE
*
...
<div class="row addresses-lists">
	<div class="col-xs-12 col-sm-6 col-lg-4">
		<ul class="myaccount-link-list">
            ...
            {*<li><a href="{$link->getPageLink('addresses', true)|escape:'html':'UTF-8'}" title="{l s='Addresses'}"><i class="icon-building"></i><span>{l s='My addresses'}</span></a></li><!-- Добавление адресов -->*}
...
<li><a class="btn btn-default button button-small aDirect" href="{$base_dir}" title="{l s='Home'}"><span><i class="icon-chevron-left"></i> {l s='Home'}</span></a></li>
</ul>
