...
<div class="box">
    <p>{l s='Your order on' mod='cashondelivery'} <span class="bold">{$shop_name}</span> {l s='is complete.' mod='cashondelivery'}
        ...
        <!-- <br /><span class="bold">{l s='Your order will be sent very soon.' mod='cashondelivery'} -->
        <span class="bold"> Cпасибо за заказ! В ближайшее время с Вами свяжется один из наших менеджеров для уточнения деталей</span>
