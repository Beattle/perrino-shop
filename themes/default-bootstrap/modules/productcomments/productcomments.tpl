...
*
* NOTICE OF LICENSE _tat_ вывод комментов. просто добавила классы displayNone и submitNewMessage превратила из button в input
*
			...
			{foreach from=$comments item=comment}
				...
				<div class="comment row" itemprop="review" itemscope itemtype="http://schema.org/Review">
					<div class="comment_author col-sm-2">
						<span class="displayNone">{l s='Grade' mod='productcomments'}&nbsp;</span>{*Оценка*}
						<div class="star_content clearfix displayNone"  itemprop="reviewRating" itemscope itemtype="http://schema.org/Rating">
...
{*            				<meta itemprop="worstRating" content = "0" />
					...
					<div class="comment_details col-sm-10">
						<p itemprop="name" class="title_block displayNone">{*Заголовок комментария*}
		...
		<form id="id_new_comment_form" action="#">
			...
			<div class="row">
				...
				<div class="new_comment_form_content col-xs-12 col-sm-6">
					...
					{* Показывает этот блок, хотя не должен
					...
					<div id="new_comment_form_footer">
						...
						<p class="fr">
							<input id="submitNewMessage" name="submitMessage" type="submit" class="btn button button-small" value="{l s='Submit' mod='productcomments'}" />
							&nbsp;
