...
*
* NOTICE OF LICENSE _tat_ Выводит блок расширенных фильтров. Кажется ничего не меняла
*
...
<!-- _tat_ Эти файлы подключались в FrontController.php Но тогда не работала рассылка А это фильтры-->	
<script src="{$base_dir}/themes/default-bootstrap/js/autoload1/10-bootstrap.min.js"></script>
<script src="{$base_dir}/themes/default-bootstrap/js/autoload1/15-jquery.total-storage.min.js"></script>
<script src="{$base_dir}/themes/default-bootstrap/js/autoload1/15-jquery.uniform-modified.js"></script>
</head>


<div  id="title_3" class="left_title">
				 Выбор матраса
			 </div>
			 <div class="left_filter">
				...
				<p>Макс. вес на место </p>
				<select>
					 <option>100 кг</option>
					 <option>110 кг</option>
					 <option>120 кг</option>
				</select>
				<input class="se" type="submit" id="submit" value="Подобрать" title=""/>
			 </div>

<!-- Block layered navigation module -->
{if $nbr_filterBlocks != 0}
<div id="layered_block_left" class="block">
	<div  id="title_2" class="left_title">
		<p class="title_block">{l s='Выбор матраса' mod='blocklayered'}</p>
	</div>
