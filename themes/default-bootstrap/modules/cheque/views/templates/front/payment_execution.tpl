...
*
* NOTICE OF LICENSE _tat_ Оплата заказа чеком (две кнопки buttontat)
*
...
{else}
	...
	<form action="{$link->getModuleLink('cheque', 'validation', [], true)|escape:'html':'UTF-8'}" method="post">
		...
		<p class="cart_navigation clearfix" id="cart_navigation">
			<a href="{$link->getPageLink('order', true, NULL, "step=3")|escape:'html':'UTF-8'}" class="button-exclusive btn btn-default buttontat">
				<i class="icon-chevron-left"></i>{l s='Other payment methods' mod='cheque'}
			</a>
			<button type="submit" class="button btn btn-default button-medium buttontat">
