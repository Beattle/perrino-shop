...
*
* NOTICE OF LICENSE Форма службы поддержки заказов. Переформатировала
*
...
{else}
	...
	<form action="{$request_uri}" method="post" class="contact-form-box1" enctype="multipart/form-data">
		<fieldset>
			<h3 class="page-subheading">{l s='send a message'}</h3>
			<div class="clearfix contactFormWrapper">				
					<div class="formAdress selector1">
					...
					{if !$PS_CATALOG_MODE}
						{if (!isset($customerThread.id_order) || $customerThread.id_order > 0)}
							<div class="formAdress2 selector1">
