<div id="opc_new_account" class="opc-main-block">
	...
	<h1 id="new_account_title" class="page-heading step-num"><span>1</span> {l s='Account'}</h1>
			...
			<div class="box">
				<div id="opc_account_form">
					...
					{if $field_name eq "company"}
						<div class="text form-group is_customer_param">
					...
					<div class="required text form-group is_customer_param">
					...
					<div class="required text form-group">
                        ...
                        <div class="required text form-group">
                            <label for="floor">{l s='Floor'} <sup>*</sup></label>
                            <input type="text" class="text form-control" name="floor" id="floor"  value="{if isset($guestInformations) && isset($guestInformations.floor) && isset($guestInformations) && isset($guestInformations.floor) && $guestInformations.floor}{$guestInformations.floor}{/if}" />
                        </div>
                        ...
                        <div class="required text form-group">
                            ...
                            <select name="lift" id="lift">
                                ...
                                <option {if isset($guestInformations) && isset($guestInformations.floor) && isset($guestInformations) && isset($guestInformations.floor) && $guestInformations.floor}{if $guestInformations.lift eq 'Пассажирский'}selected{/if} {/if} value="Пассажирский">Пассажирский</option>
                            </select>
                        </div>

                        <div class="text form-group">
                            <label for="code_intercom">{l s='Code_intercom'}</label>
                            <input type="text" class="text form-control" name="code_intercom" id="code_intercom"  value="{if isset($guestInformations) && isset($guestInformations.code_intercom) && isset($guestInformations) && isset($guestInformations.code_intercom) && $guestInformations.code_intercom}{$guestInformations.code_intercom}{/if}" />
                        </div>   
					...
					<div style="display: none" class="required select form-group">
