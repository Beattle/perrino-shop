...
*
*  _tat_  Страница персональной информации. Заменила form-group на formAdress Добавила aDirect. Последняя ссылка добавляется в my-account.tpl
*
        ...
        <form action="{$link->getPageLink('identity', true)|escape:'html':'UTF-8'}" method="post" class="std">
            <fieldset>
                ...
                <div class="required formAdress">
                    ...
                    <input class="is_required validate form-control" type="password" data-validate="isPasswd" name="old_passwd" id="old_passwd" value="12345678"/>
                </div>
                
                
                
                <div class="clearBotch"></div>
                <div class="password formAdress">
                    {*<label for="passwd">
                        {l s='New Password'}
                    </label>*}
                    <input class="is_required validate form-control" type="password" data-validate="isPasswd" name="passwd" id="passwd" value="12345678"/>
                </div>
                <div class="clearBotch"></div>
                <div class="password formAdress">
                    ...
                    <input class="is_required validate form-control" type="password" data-validate="isPasswd" name="confirmation" id="confirmation" value="12345678"/>
                </div>
                <div class="clearBotch"></div>
                {if $newsletter}
                    <div class="checkbox">
			...
			{/if}
                ...
                <div class="formAdress">
                    <button type="submit" name="submitIdentity" class="btn btn-default button button-medium buttontat">
...
<ul class="footer_links clearfix">
	<li>
        <a class="btn btn-default button button-small buttontat" href="{$link->getPageLink('my-account', true)}">
            <span>
	...
	<li>
        <a class="btn btn-default button button-small buttontat" href="{$base_dir}">
            <span>
