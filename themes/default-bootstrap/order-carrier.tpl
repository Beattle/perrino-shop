{*
* 2007-2015 PrestaShop _перевозчик. Второй шаг зкаказа, который не нужен _tat_
*
* NOTICE OF LICENSE
*
...
{if !$opc}
	...
	<div id="carrier_area">
		...
		{include file="$tpl_dir./order-steps.tpl"}<!-- Можно не подключать -->
...
{else}
	<div id="carrier_area" class="opc-main-block">
		{*<h1 class="page-heading step-num"><span>2</span> {l s='Delivery methods'}</h1>*}
			<div id="opc_delivery_methods" class="opc-main-block" hidden>
									...
									<div>
										<table class="resume table table-bordered{if !$option.unique_carrier} hide{/if}">
											<tr>
												...
												</td><!-- Самое золото, тот самый перевозчик. Больше отсюда ничего не надо -->
