{*
* 2007-2015 PrestaShop _tat_ Оформление заказа, способы оплаты, добавила h3 Выберите способы оплаты. С $HOOK_PAYMENT подключается payment.tpl
*
* NOTICE OF LICENSE
*
...
{else}
	{*<h1 class="page-heading step-num"><span>3</span> {l s='Please choose your payment method'}</h1> Выберите способ оплаты)*}
{/if}
		...
		<div class="paiement_block">
			<div id="HOOK_TOP_PAYMENT">{$HOOK_TOP_PAYMENT}</div>
				{if $HOOK_PAYMENT}
					...
					<div id="HOOK_PAYMENT">
						<!-- В заказ выводятся формы оплаты -->
						{$HOOK_PAYMENT}
					</div>
				...
				{if !$opc}
					<p class="cart_navigation clearfix">
						<a href="{$link->getPageLink('order', true, NULL, "step=2")|escape:'html':'UTF-8'}" title="{l s='Previous'}" class="button-exclusive btn btn-default buttontat">
