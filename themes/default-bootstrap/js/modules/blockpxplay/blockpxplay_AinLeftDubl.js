...
$(document).ready(function()
{
	...
	$(document).on('click', '#layered_pxp_form .select, #layered_pxp_form input[type=checkbox], #layered_pxp_form input[type=radio], .selectButton', function(e) {
...
function hideFilterValueAction(it)//Убирала
{
