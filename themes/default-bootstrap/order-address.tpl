{*
* 2007-2015 PrestaShop _tat_ выводит окно "Добавить новый адресс" btn-default. Меняла btn-default кнопок на btn-default1
*
* NOTICE OF LICENSE
*
...
{/if}
<div class="addresses_hide clearfix">
	<div class="row">
...
{if !$opc}
			<p class="cart_navigation clearfix">
				...
				<a href="{$link->getPageLink($back_order_page, true, NULL, "{if $back}back={$back}{/if}")|escape:'html':'UTF-8'}" title="{l s='Previous'}" class="button-exclusive btn btn-default1">
					<i class="icon-chevron-left"></i>
					{l s='Continue Shopping'}
				</a>
				<button type="submit" name="processAddress" class="button btn btn-default1 button-medium">
