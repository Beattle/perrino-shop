...
* _tat_ Ситраница Мои адреса. Меняла классы, очерёдность
* NOTICE OF LICENSE
*
...
<div class="clearfix main-page-indent">
	<a href="{$link->getPageLink('address', true)|escape:'html':'UTF-8'}" title="{l s='Add an address'}" class="btn btn-default button button-medium aAdress"><span>{l s='Add a new address'}<i class="icon-chevron-right right"></i></span></a>
</div>
<ul class="footer_links clearfix aDirect">
	<li><a class="btn btn-default button button-small aAdress" href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}"><span><i class="icon-chevron-left"></i> {l s='Back to your account'}</span></a></li>
</ul>
<ul class="footer_links clearfix aDirect1">
	<li><a class="btn btn-default button button-small aAdress" href="{$base_dir}"><span><i class="icon-chevron-left"></i> {l s='Home'}</span></a></li>
</ul>
